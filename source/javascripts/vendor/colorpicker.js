		...
		var
			...
			setSelector = function (hsb, cal) {
				...
				$(cal).data('colorpicker').selectorIndic.css({
					left: parseInt(300 * hsb.s/100, 10),
					top: parseInt(300 * (100-hsb.b)/100, 10)
				});
			},
			setHue = function (hsb, cal) {
				$(cal).data('colorpicker').hue.css('top', parseInt(300 - 300 * hsb.h/360, 10));
			},
			...
			moveHue = function (ev) {
				change.apply(
					ev.data.cal.data('colorpicker')
						.fields
						.eq(4)
						.val(parseInt(360*(300 - Math.max(0,Math.min(300,(ev.pageY - ev.data.y))))/300, 10))
						.get(0),
					[ev.data.preview]
				);
				return false;
			...
			moveSelector = function (ev) {
				change.apply(
					ev.data.cal.data('colorpicker')
						.fields
						.eq(6)
						.val(parseInt(100*(300 - Math.max(0,Math.min(300,(ev.pageY - ev.data.pos.top))))/300, 10))
						.end()
						.eq(5)
						.val(parseInt(100*(Math.max(0,Math.min(300,(ev.pageX - ev.data.pos.left))))/300, 10))
						.get(0),
					[ev.data.preview]
				);
				return false;
